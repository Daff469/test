...
""" PEMBUATAN CLASS QUESTION UNTUK SIMPAN PERTANYAAN """
class Question:
...
""" BUAT PERTANYAAN """
LIST_TANYA = list()
LIST_TANYA.append(Question("Kapan Minecraft rilis?", '2011', '2012', '2013', '2014'))
LIST_TANYA.append(Question("Kapan GTA5 rilis?", '2013', '2012', '2011', '2014'))
LIST_TANYA.append(Question("Kapan PS4 rilis?", '2014', '2012', '2013', '2011'))
LIST_TANYA.append(Question("Kapan PS5 rilis?", '2020', '2021', '2022', '2023'))
LIST_TANYA.append(Question("Kapan GTA6 rilis?", '2025', '2026', '2027', '2028'))
...
def tanya(tanya):
    shuffle(LIST_TANYA) ## acak jawaban
...
jendela.total_jawaban = 0
def next_question():
    #jendela.pertanyaan_sekarang = jendela.pertanyaan_sekarang + 1
...
def periksa_jawaban():
    if LIST_TOMBOL[0].isChecked() :
        jendela.total_jawaban += 1
        tampil_hasil("BENAR")
    else:
        tampil_hasil("SALAH")
    print('Total pertanyaan:', jendela.total_pertanyaan)
    print('Total jawaban benar:', jendela.total_jawaban)
    print('rating', round((jendela.total_jawaban/jendela.total_pertanyaan)*100, 2), '%')
...
""" EVENT HANDLER """
#tanya("HARI SENIN HARI APA?", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY")
#tanya (LIST_TANYA[1])
next_question()
